    ...
    <div className={sendersSection}>
      {messagesData.map((user) => (
        <div className={senderInfo}>
          <Link to={`/direct/${user.from_user_id}`}>
            <img
...
export function Messages({ fromUserId }) {
  ...
  const userIndex = messagesData?.findIndex((user) => user.from_user_id === fromUserId);
  ...
  return (
    <div className={messagesPageContainer}>
      ...
      <div className={rightSection}>
        <div className={messagesSenderInfo}>
          <img
          ...
          <div className={messagesBody}>
            ...
            {messagesData[userIndex]?.messages.map((message, index) => {
              ...
              return (
                ...
                >
                  {message.direction !==
                    messagesData[userIndex]?.messages[nextMessage]?.direction &&
